...
##fig1.errorbar(xjack,yjack, yerr=ejack, c='#20639B', ls='None', marker='o', markersize=6, capsize=1, elinewidth=0.7,label="Jackknive")
#Plot del ajust
plt.plot(xplot, yplot_l, 'r-', label='fit: k=%5.3f (l.u.)' % tuple(millor_c_l))
...
plt.legend()
#plt.show()
with PdfPages('bestEMP_prot_lineal_f29.pdf') as pdf:
    pdf.savefig(fig)
...
##fig1.errorbar(xjack,yjack, yerr=ejack, c='#20639B', ls='None', marker='o', markersize=6, capsize=1, elinewidth=0.7,label="Jackknive")
#Plot del ajust
plt.plot(xplot, yplot_e, 'r-', label='fit: a=%5.3f, b=%5.3f, c=%5.3f (l.u.)' % tuple(millor_c_e))
#Error de l'ajust
fig1.add_patch(
    patches.Rectangle(
...
plt.legend()
#plt.show()
with PdfPages('bestEMP_prot_exp_f29.pdf') as pdf:
    pdf.savefig(fig)
